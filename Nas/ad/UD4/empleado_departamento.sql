...
-- Dump completed on 2017-07-01 23:44:10

ALTER TABLE departamentos ADD CONSTRAINT fk_EmpDir FOREIGN KEY (codDirector) REFERENCES empleados(nDIEMP) ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE empleados ADD CONSTRAINT FK_Empl FOREIGN KEY (jefeID) REFERENCES empleados(nDIEmp);
