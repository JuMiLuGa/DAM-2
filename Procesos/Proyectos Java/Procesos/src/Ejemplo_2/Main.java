...
public class Main {
    ...
    public static void lanzarSumador(
        ...
        String comando;
        comando="Ejemplo_2.Sumador";

        File directorioSumador;
        directorioSumador=new File("E:\\DAM-2\\Procesos\\workspace\\Multiproceso1\\bin\\");
    ...
    public static void main(String[] args) throws IOException, InterruptedException{
        ...
        for (int i=1;i<=NUM_PROCESOS; i++){
            ...
            lanzarSumador(n1, n1+salto , PREFIJO_FICHEROS+String.valueOf(i));n1=n1 + salto + 1;
